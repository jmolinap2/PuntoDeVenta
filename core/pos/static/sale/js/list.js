            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        buttons += '<a rel="details" class="btn btn-success btn-sm"><i class="fas fa-search"></i></a> ';
                        buttons += '<a href="' + pathname + 'invoice/pdf/' + row.id + '/" target="_blank" class="btn btn-info btn-sm"><i class="fas fa-file-pdf"></i></a> ';
                        return buttons;
                    }
                },
            ],
