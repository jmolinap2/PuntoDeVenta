...
var sale = {
    ...
    calculateInvoice: function () {
        var subtotal = 0.00;
        this.details.iva = parseFloat($('input[name="iva"]').val());
        ...
        this.details.total_dscto = 0.00;
        this.details.total_dscto = (this.details.dscto / 100) * this.details.subtotal;
        ...
        tblProducts = $('#tblProducts').DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    orderable: false,
                    render: function (data, type, row) {
                        return '<a rel="remove" class="btn btn-danger btn-sm" style="color: white;"><i class="fas fa-trash-alt"></i></a>';
                    }
                },
                {
                    targets: [-3],
            ...
            rowCallback(row, data, displayNum, displayIndex, dataIndex) {
                ...
                $(row).find('input[name="cant"]').TouchSpin({
                    min: 1,
                    max: !data.is_service ? data.stock : 1000000,
                    step: 1
                });
...
$(function () {
    ...
    select_search_product = $('input[name="search"]');
        ...
        tblSearchProducts = $('#tblSearchProducts').DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    orderable: false,
                    render: function (data, type, row) {
                        var buttons = '<a rel="add" class="btn btn-success btn-sm"><i class="fas fa-plus"></i></a> ';
                        return buttons;
                    }
                },
            ],
